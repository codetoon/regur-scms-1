                ...
                <div class="card-body">
                    <form method="POST" action="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="company_name" type="text" class="form-control{{ $errors->has('company_name') ? ' is-invalid' : '' }}" name="company_name" value="{{ old('company_name', $organization->name) }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ddi" type="text" class="form-control{{ $errors->has('ddi') ? ' is-invalid' : '' }}" name="ddi" value="{{ old('ddi') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tollfree_number" type="text" class="form-control{{ $errors->has('tollfree_number') ? ' is-invalid' : '' }}" name="tollfree_number" value="{{ old('tollfree_number') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="purchase_email" type="text" class="form-control{{ $errors->has('purchase_email') ? ' is-invalid' : '' }}" name="purchase_email" value="{{ old('purchase_email') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="sales_email" type="text" class="form-control{{ $errors->has('sales_email') ? ' is-invalid' : '' }}" name="sales_email" value="{{ old('sales_email') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="fax_number" type="text" class="form-control{{ $errors->has('fax_number') ? ' is-invalid' : '' }}" name="fax_number" value="{{ old('fax_number') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="physical_address_name" type="text" class="form-control{{ $errors->has('physical_address_name') ? ' is-invalid' : '' }}" name="physical_address_name" value="{{ old('physical_address_name') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="physical_address_line_1" type="text" class="form-control{{ $errors->has('physical_address_line_1') ? ' is-invalid' : '' }}" name="physical_address_line_1" value="{{ old('physical_address_line_1') }}" required autofocus>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="physical_address_line_2" type="text" class="form-control{{ $errors->has('physical_address_line_2') ? ' is-invalid' : '' }}" name="physical_address_line_2" value="{{ old('physical_address_line_2') }}" required autofocus>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="physical_suburb" type="text" class="form-control{{ $errors->has('physical_suburb') ? ' is-invalid' : '' }}" name="physical_suburb" value="{{ old('physical_suburb') }}" required autofocus>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="physical_city" type="text" class="form-control{{ $errors->has('physical_city') ? ' is-invalid' : '' }}" name="physical_city" value="{{ old('physical_city') }}" required autofocus>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="physical_state_region" type="text" class="form-control{{ $errors->has('physical_state_region') ? ' is-invalid' : '' }}" name="physical_state_region" value="{{ old('physical_state_region') }}" required autofocus>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="physical_postal_code" type="text" class="form-control{{ $errors->has('physical_postal_code') ? ' is-invalid' : '' }}" name="physical_postal_code" value="{{ old('physical_postal_code') }}" required autofocus>
                        ...
                        <div><h5>Postal Address</h5></div>
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="postal_address_name" type="text" class="form-control{{ $errors->has('postal_address_name') ? ' is-invalid' : '' }}" name="postal_address_name" value="{{ old('postal_address_name') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="postal_address_line_1" type="text" class="form-control{{ $errors->has('postal_address_line_1') ? ' is-invalid' : '' }}" name="postal_address_line_1" value="{{ old('postal_address_line_1') }}" required autofocus>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="postal_address_line_2" type="text" class="form-control{{ $errors->has('postal_address_line_2') ? ' is-invalid' : '' }}" name="postal_address_line_2" value="{{ old('postal_address_line_2') }}" required autofocus>
                         ...
                         <div class="form-group row">
                            <label for="postal_suburb" class="col-md-4 col-form-label text-md-right">{{ __('postal_suburb') }}</label>

                            <div class="col-md-6">
                                <input id="postal_suburb" type="text" class="form-control{{ $errors->has('postal_suburb') ? ' is-invalid' : '' }}" name="postal_suburb" value="{{ old('postal_suburb') }}" required autofocus>
                         ...
                         <div class="form-group row">
                            <label for="postal_city" class="col-md-4 col-form-label text-md-right">{{ __('postal_city') }}</label>

                            <div class="col-md-6">
                                <input id="postal_city" type="text" class="form-control{{ $errors->has('postal_city') ? ' is-invalid' : '' }}" name="postal_city" value="{{ old('postal_city') }}" required autofocus>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="postal_state_region" type="text" class="form-control{{ $errors->has('postal_state_region') ? ' is-invalid' : '' }}" name="postal_state_region" value="{{ old('postal_state_region') }}" required autofocus>
...
=======
                         <div class="form-group-row">
							<label for="country" class="col-form-label text-md-right">Country</label>
								...
								<select class="form-control" name="postal_country_id" id="country">
								@foreach($countries as $country) 
									<option value= "{{ $country->id }}">{{ $country->country_name }}</option>
								@endforeach
								</select>
...
>>>>>>> Stashed changes:resources/views/organization-details-form.blade.php
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="postal_postal_code" type="text" class="form-control{{ $errors->has('postal_postal_code') ? ' is-invalid' : '' }}" name="postal_postal_code" value="{{ old('postal_postal_code') }}" required autofocus>
