...
Route::get('/company/organization-details/{organization}', 'OrganizationsController@edit'); 
Route::post('/company/organization-details/{organization}', 'OrganizationsController@update'); //update org details
...
Route::post('/system/attributes/{attribute}', 'System\AttributesController@store');
